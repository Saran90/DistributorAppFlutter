...
class GetAllFailedOrderSummariesUseCase extends UseCase<List<HiveOrderSummaryModel>?, NoParams> {
  final OrderSummaryRepository orderSummaryRepository;

  GetAllFailedOrderSummariesUseCase({required this.orderSummaryRepository});

  @override
  Future<Either<Failure, List<HiveOrderSummaryModel>?>> call(params) {
    return orderSummaryRepository.getAllFailedOrders();
  }
}