...
class GetAllOrderSummariesUseCase extends UseCase<List<HiveOrderSummaryModel>?, NoParams> {
  final OrderSummaryRepository orderSummaryRepository;

  GetAllOrderSummariesUseCase({required this.orderSummaryRepository});

  @override
  Future<Either<Failure, List<HiveOrderSummaryModel>?>> call(params) {
    return orderSummaryRepository.getAllOrders();
  }
}